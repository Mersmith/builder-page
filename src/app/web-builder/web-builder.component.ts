...
export class WebBuilderComponent implements OnInit {
  ...
  <header class="header-banner">
    <div class="container-width">
      <div id="iny5" class="logo-container">
        <div class="logo">GrapesJS
        </div>
      </div>
      <nav id="iq3q" class="menu">
        <div id="icnf" class="menu-item">BUILDER
        </div>
        <div id="ihag" class="menu-item">TEMPLATE
        </div>
        <div id="ivsvk" class="menu-item">WEB
        </div>
      </nav>
      <div class="clearfix">
      </div>
      <div id="i2ym6" class="lead-title">Build your templates without coding
      </div>
      <div id="i39g3" class="sub-lead-title">All text blocks could be edited easily with double clicking on it. You can create new text blocks with the command from the left panel
      </div>
  ...
  <section class="flex-sect">
    <div class="container-width">
      ...
      <div class="cards">
        ...
        <div class="card">
          <div id="ikz7j" class="card-header ch2">
          </div>
          <div class="card-body">
        ...
        <div class="card">
          <div id="iwehf" class="card-header ch5">
          </div>
          <div class="card-body">
            <div class="card-title">Title five
            </div>
            <div id="i7vfq" class="card-sub-title">Subtitle five
            </div>
            <div class="card-desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
            </div>
          </div>
  ...
  <section class="am-sect">
    <div class="container-width">
      <div id="itkch" class="am-container">
        <img src="./img/phone-app.png" id="icj1j" class="img-phone"/>
        <div class="am-content">
          <div class="am-pre">ASSET MANAGER
          </div>
          <div id="iqanx" class="am-title">Manage your images with Asset Manager
          </div>
  ...
  <section class="bdg-sect">
    <div class="container-width">
      <h1 id="i4jevq" class="bdg-title">The team
      </h1>
      <div class="badges">
        <div class="badge">
        ...
        <div class="badge">
          ...
          <img src="img/team2.jpg" id="if0u2t" class="badge-avatar"/>
          <div class="badge-body">
          ...
          <div id="i13lju" class="badge-foot">
            <span id="iyl33u" class="badge-link">ln</span>
            <span id="i1u5uw" class="badge-link">t</span>
            <span id="i8otor" class="badge-link">f</span>
          </div>
        </div>
        <div class="badge">
          <div class="badge-header">
          </div>
          <img src="img/team3.jpg" id="i1v9dv" class="badge-avatar"/>
          <div class="badge-body">
  ...
  ngOnInit(): void {
    ...
    this.editor.Commands.add('save-db', {
      run: (editor: any, sender: any) => {
        ...
        this.save(htmldata, cssdata);
      }
    });

  }

  save(htmldata: any, cssdata: any) {
